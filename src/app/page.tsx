...
export default function EConexGroupApp() {
  ...
  const categoryImages = {
    higienizacao: {
      url: 'https://img.freepik.com/premium-photo/young-black-man-uniform-yellow-gloves-using-vacuum-cleaner_274679-35137.jpg',
  ...
  const banners = [
    {
      title: 'EConex Group - Serviços Profissionais',
      subtitle: 'Design de Interiores, Manutenção, Climatização, Higienização profissional de Espaços, Automóveis e Piscinas',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 pt-28">
      ...
      <header className="absolute top-0 left-0 w-full z-50 bg-transparent">
        <div className="container mx-auto px-4 py-3 bg-white/85 backdrop-blur-md shadow-lg rounded-b-2xl">
